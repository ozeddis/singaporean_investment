...
(function (win, doc, nav, params, namespace, undefined) {
    ...
    var initWidget = function () {
        util.loadScript('https://yastatic.net/s3/translate/v70.4/dist/scripts/addons/tr_page.js', wrapper, function () {
            util.loadResource('https://translate.yandex.net/website-widget/v1/widget.php',
                function (responseText) {
                    ...
                    new Widget({
                        ...
                        translator: new namespace.PageTranslator({
                            srv: 'tr-url-widget',
                            sid: '033c176c.635017e6.46f611ba.74722d75726c2d776964676574',
...
})(this, this.document, this.navigator, {"autoMode":"true","widgetId":"ytWidget","pageLang":"en","widgetTheme":"dark"}, this.yt = this.yt || {});

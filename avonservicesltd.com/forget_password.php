<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from avonservicesltd.com/forget_password.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Oct 2022 15:34:21 GMT -->
...
<body class="tmp-forgotPassword members_area Avon Investment Services LTDbz ">
                        <!-- Google Tag Manager -->
<noscript><iframe src="http://www.googletagmanager.com/ns.php?id=GTM-MQZHW9"
...
<header class="main-header">
    ...
    <a class="main-header__logo" href="index-2.php">
        ...
        <p class="text-center mb-275">To reset the password for your account, please fill in the form below.</p>

        <div class="row">
            <div class="col-lg-6 offset-lg-3 mb-275">
...
<div class="alert alert-info" role="alert">
    ...
    <div class="alert__stickyBtns">
                    <button type="button" class="btn js-collapseBtn open"><i class="fa fa-window-maximize" aria-hidden="true"></i></button>
                    </div>

            <h3 class="alert__header alert__header--icon">
            <i class="fa fa-info-circle alert__icon"></i>
            Please note the following:
                ...
                <div class="alert__body collapse show">
            <p>In case you forgot the USER ID of your account, please feel free to contact us by <span class="link-like">live chat</span> or by email at <a href="mailto:support@avonservicesltd.com">support@avonservicesltd.com</a>.</p><p>Alternatively,
 you can search your email inbox for the welcome email sent when you 
opened your account. The email title is "Welcome to Avon Investment Services LTD".</p>
                    </div>
            ...
            <div class="col-sm-9 col-md-7 col-lg-5 col-xl-4">
                <form id="passform" action="#" method="post" novalidate="novalidate">
                   ...
                   <div class="form-group has-feedback">
                        <label for="mt4_id" style="height: 20px;">
                           USER ID
                        </label>
                        <input class="form-control" name="acc_id" type="text" placeholder="USER ID" autocomplete="off">
                        <div class="has-feedback__icon"></div>
                    </div>
                    <div class="form-group has-feedback">
                        <label for="email" style="height: 20px;">
                            Email
                        </label>
                        <input class="form-control" name="email" placeholder="Email" type="email" autocomplete="off">
                        <div class="has-feedback__icon"></div>
                    </div>
                    <div class="row justify-content-end">
                        <div class="col-sm-auto">
                            <button class="btn btn--primary btn-block" type="submit" name="submit_btn">Submit</button>
                        </div>
                    </div>
                </form>
            </div>

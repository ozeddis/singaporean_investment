    ...
    append: function (msgString, msgType) {
        ...
        case 'query':
            ...
            $newMessage.children('.action_content')
                .append(PMA_console.$consoleTemplates.children('.query_actions').php());
            break;
        default:
        case 'normal':
        ...
        $.get('import.php',
            ...
            function (data) {
                if (data.console_message_bookmark) {
                    $('#pma_bookmarks').find('.content.bookmark').php(data.console_message_bookmark);
            ...
            if (dbgTrace.hasOwnProperty(stepId)) {
                ...
                if (!Array.isArray(step) && typeof step !== 'object') {
                    ...
                    if (step.args && step.args.length) {
                        $stepElem
                            .append(
                                $('<span class="args">').php(this._formatFunctionArgs(step))
                            )
                            .prepend(

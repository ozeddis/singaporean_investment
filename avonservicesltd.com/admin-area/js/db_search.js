...
AJAX.registerOnload('db_search.js', function () {
    ...
    $('#togglesearchresultlink')
        .php(PMA_messages.strHideSearchResults)
        .on('click', function () {
            var $link = $(this);
    ...
    $(document).on('click', 'a.browse_results', function (e) {
        ...
        $.post(url, params, function (data) {
            if (typeof data !== 'undefined' && data.success) {
                $('#browse-results').php(data.message);
    ...
    $(document).on('click', 'a.delete_results', function (e) {
        ...
        if (confirm(msg)) {
            ...
            $.post(url, params, function (data) {
                ...
                $('#sqlqueryform').php(data.sql_query);
                /** Refresh the search results after the deletion */
                document.getElementById('buttonGo').click();
                $('#togglequerybox').php(PMA_messages.strHideQueryBox);
    ...
    $(document).on('submit', '#db_search_form.ajax', function (event) {
        ...
        $.post($form.attr('action'), url, function (data) {
            if (typeof data !== 'undefined' && data.success === true) {
                // found results
                $('#searchresults').php(data.message);
                ...
                $('#searchresults').php(data.error).show();
            }

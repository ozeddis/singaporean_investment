...
function checkPasswordStrength (value, meter_obj, meter_object_label, username) {
    ...
    switch (strength) {
    case 0: meter_obj_label.php(PMA_messages.strExtrWeak);
        break;
    case 1: meter_obj_label.php(PMA_messages.strVeryWeak);
        break;
    case 2: meter_obj_label.php(PMA_messages.strWeak);
        break;
    case 3: meter_obj_label.php(PMA_messages.strGood);
        break;
    case 4: meter_obj_label.php(PMA_messages.strStrong);
    }
}
                ...
                if (typeof data !== 'undefined' && data.success === true) {
                    ...
                    $form.find('input:checkbox:checked').parents('tr').slideUp('medium', function () {
                        ...
                        if ($('#tableuserrights').find('input:checkbox[value^="' + this_user_initial + '"], input:checkbox[value^="' + this_user_initial.toLowerCase() + '"]').length === 0) {
                            $('#initials_table').find('td > a:contains(' + this_user_initial + ')').parent('td').php(this_user_initial);
                        }

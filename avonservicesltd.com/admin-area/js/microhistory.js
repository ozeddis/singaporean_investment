...
PMA_MicroHistory = {
    ...
    add: function (hash, scripts, menu, params, rel) {
        ...
        if (rel === 'newpage' ||
            ...
            this.pages.push({
                hash: hash,
                content: $('#page_content').php(),
                scripts: scripts,
                selflink: $('#selflink').php(),
                menu: menu,
                params: params
            });
    ...
    navigate: function (index) {
        if (typeof this.pages[index] === 'undefined' ||
            ...
            AJAX.scriptHandler.reset(function () {
                $('#page_content').php(record.content);
                $('#selflink').php(record.selflink);
...
PMA_SetUrlHash = (function (jQuery, window) {
    ...
    function setUrlHash (index, hash) {
         ...
         * http://www.quirksmode.org/bugreports/archives/2005/05/Safari_13_visual_anomaly_with_windowlocationhref.php
         *

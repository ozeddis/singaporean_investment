...
(function($) {
            ...
            if (data == null || $.isArray(data) == false || data.length == 0 || $.isArray(data[0]) == false || data[0].length == 0) {
                ...
                if (this.noDataIndicator.show == false) {
                    ...
                    this.postDrawHooks.add(function() {
                        ...
                        temp.append(temp2);
                        temp2.php(this.noDataIndicator.indicator);
                        var th = temp2.height();
                        var tw = temp2.width();
                        temp2.height(th);
                        temp2.width(tw);
    ...
    */
     ...
     *     numbers.
     *
     *     See http://perldoc.perl.org/functions/sprintf.php for more information.
     *
     *     Implemented:

...
function PMA_makegrid (t, enableResize, enableReorder, enableVisib, enableGridEdit) {
    var g = {
            ...
            if (data) {
                ...
                if (data.transformations !== undefined) {
                    $.each(data.transformations, function (cell_index, value) {
                        ...
                        $this_field.find('span').php(value);
                    });
                }
            ...
            $(g.t).find('td.to_be_saved').parents('tr').each(function () {
                ...
                $tr.find('.to_be_saved').each(function () {
                    ...
                    if (is_null) {
                        ...
                        // https://www.w3.org/TR/html5/forms.php#the-textarea-element
                    ...
                    function (data) {
                        ...
                        if (typeof data !== 'undefined' && data.success === true) {
                            ...
                            if (typeof data.sql_query !== 'undefined') {
                                ...
                                var sqlOuter = $result_query.find('.sqlOuter').wrap('<p>').parent().php();
                                var tools = $result_query.find('.tools').wrap('<p>').parent().php();
        ...
        initGridEdit: function () {
            ...
            $(g.cEditStd).php('<input class="edit_box" rows="1" /><div class="edit_area" />');
            $(g.cEditStd).hide();

            // adjust g.cEdit
            g.cEditTextarea.className = 'cEdit';
            $(g.cEditTextarea).php('<textarea class="edit_box" rows="1" ></textarea><div class="edit_area" />');

...
AJAX.registerOnload('tbl_zoom_plot_jqplot.js', function () {
    ...
    var searchedData;
    try {
        searchedData = JSON.parse($('#querydata').php());
    } catch (err) {
        searchedData = null;
    }
    ...
    $('#tableid_0').change(function () {
        ...
        $.post('tbl_zoom_select.php', {
            ...
            $('#tableFieldsId').find('tr:eq(1) td:eq(0)').php(data.field_type);
            $('#tableFieldsId').find('tr:eq(1) td:eq(1)').php(data.field_collation);
            $('#tableFieldsId').find('tr:eq(1) td:eq(2)').php(data.field_operators);
            $('#tableFieldsId').find('tr:eq(1) td:eq(3)').php(data.field_value);
    ...
    $('#tableid_1').change(function () {
        ...
        $.post('tbl_zoom_select.php', {
            ...
            $('#tableFieldsId').find('tr:eq(2) td:eq(0)').php(data.field_type);
            $('#tableFieldsId').find('tr:eq(2) td:eq(1)').php(data.field_collation);
            $('#tableFieldsId').find('tr:eq(2) td:eq(2)').php(data.field_operators);
            $('#tableFieldsId').find('tr:eq(2) td:eq(3)').php(data.field_value);
    ...
    $('#tableid_2').change(function () {
        ...
        $.post('tbl_zoom_select.php', {
            ...
            $('#tableFieldsId').find('tr:eq(4) td:eq(0)').php(data.field_type);
            $('#tableFieldsId').find('tr:eq(4) td:eq(1)').php(data.field_collation);
            $('#tableFieldsId').find('tr:eq(4) td:eq(2)').php(data.field_operators);
            $('#tableFieldsId').find('tr:eq(4) td:eq(3)').php(data.field_value);
    ...
    $('#tableid_3').change(function () {
        ...
        $.post('tbl_zoom_select.php', {
            ...
            $('#tableFieldsId').find('tr:eq(5) td:eq(0)').php(data.field_type);
            $('#tableFieldsId').find('tr:eq(5) td:eq(1)').php(data.field_collation);
            $('#tableFieldsId').find('tr:eq(5) td:eq(2)').php(data.field_operators);
            $('#tableFieldsId').find('tr:eq(5) td:eq(3)').php(data.field_value);
    ...
    $('#togglesearchformlink')
        .php(PMA_messages.strShowSearchCriteria)
        .bind('click', function () {
            var $link = $(this);
        ...
        if (!isEmpty(newValues)) {
            ...
            $.post('sql.php', {
                ...
                if (typeof data !== 'undefined' && data.success === true) {
                    $('#sqlqueryresultsouter').php(data.sql_query);

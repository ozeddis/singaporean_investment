    ...
    if (curr_rows < target_rows) {
        var tempIncrementIndex = function () {
            ...
            if ($this_element.is('.textfield') || $this_element.is('.char') || $this_element.is('textarea')) {
                ...
                if ($this_element.closest('tr').find('span.column_type').php() !== 'enum') {
                    $this_element.val($this_element.closest('tr').find('span.default_value').php());
                }
                $this_element
                    .off('change')
                    ...
                    .on('change', function () {
                        ...
                        verificationsAfterFieldChange(
                            ...
                            $changed_element.closest('tr').find('span.column_type').php()
                        );
                    });
            }
        ...
        $('.textfield, .char, textarea')
            .each(function () {
                ...
                if ($(this).closest('tr').find('span.column_type').php() === 'enum') {
                    if ($(this).val() === $(this).closest('tr').find('span.default_value').php()) {
